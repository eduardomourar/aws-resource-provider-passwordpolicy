...
1. Write the JSON schema describing your resource, `oc-organizations-passwordpolicy.json`
2. Implement your resource handlers in `oc_organizations_passwordpolicy/handlers.py`
